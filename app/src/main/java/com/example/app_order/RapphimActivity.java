...
public class RapphimActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTieptuc.setOnClickListener(v -> {
            if (selectedRap == null) {
                Toast.makeText(RapphimActivity.this, "Vui lòng chọn một rạp!", Toast.LENGTH_SHORT).show();
            } else {
                Intent intent = new Intent(RapphimActivity.this, RapDetailActivity.class);
    ...
    private void loadKhuVucData() {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(RapphimActivity.this, "Lỗi tải dữ liệu từ Firebase", Toast.LENGTH_SHORT).show();
            }
        });
    }

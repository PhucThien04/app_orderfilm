...
//
//    public class PhimAdapter extends RecyclerView.Adapter<com.example.app_order.PhimAdapter.MovieViewHolder> {
...
//        }
//
//        public PhimAdapter(ChitietrapphimActivity chitietrapphimActivity, List<Phim> movieList) {
//        }
//
//        @NonNull
//        @Override
//        public com.example.app_order.PhimAdapter.MovieViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
//            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_phim, parent, false);
//            return new com.example.app_order.PhimAdapter.MovieViewHolder(view);
//        }
//
//        @Override
//        public void onBindViewHolder(@NonNull com.example.app_order.PhimAdapter.MovieViewHolder holder, int position) {
